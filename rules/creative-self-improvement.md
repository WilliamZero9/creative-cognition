...
After every creative output that receives a clear signal (positive or negative), log a decision record to `~/.claude/skills/creative/creative_trajectories.md`.
...
When creative output misses, classify WHY using the taxonomy in `~/.claude/skills/creative/creative_failure_taxonomy.md`.
